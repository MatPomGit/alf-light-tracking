...
## 34. Ulepszenie nawigacji o wizyjny SLAM
...
Node poprawia nawigację przez estymację ruchu robota na podstawie obrazu kamery.

Obsługiwane tryby:
- **Monocular VO**: ORB + dopasowanie cech + essential matrix + `recoverPose`
- **RGB-D VO**: ORB + głębia + `solvePnPRansac`, gdy depth jest dostępny
