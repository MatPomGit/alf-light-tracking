...
Publishes RGB frames from Intel RealSense D435i onto the topics expected by the
older JSON-based light follower demo. The node is isolated from the main
perception pipeline and can be launched independently.
"""
