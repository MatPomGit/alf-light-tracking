...
# CO ZMIENIONO: Dodano szkielet zakładki ExtensionsTab jako jawnie niedostępny komponent UI.
...
# TODO: Zaimplementować logikę danych i akcje operatora dla zakładki ExtensionsTab.


class ExtensionsTab(UnavailableTab):
    """Temporary tab with explicit unavailable status."""

    def __init__(self, parent=None) -> None:
        super().__init__(tab_name="ExtensionsTab", parent=parent)
