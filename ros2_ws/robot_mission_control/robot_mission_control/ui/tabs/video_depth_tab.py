...
# CO ZMIENIONO: Dodano szkielet zakładki VideoDepthTab jako jawnie niedostępny komponent UI.
...
# TODO: Zaimplementować logikę danych i akcje operatora dla zakładki VideoDepthTab.


class VideoDepthTab(UnavailableTab):
    """Temporary tab with explicit unavailable status."""

    def __init__(self, parent=None) -> None:
        super().__init__(tab_name="VideoDepthTab", parent=parent)
