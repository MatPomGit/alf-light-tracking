...
# CO ZMIENIONO: Dodano szkielet zakładki DebugTab jako jawnie niedostępny komponent UI.
...
# TODO: Zaimplementować logikę danych i akcje operatora dla zakładki DebugTab.


class DebugTab(UnavailableTab):
    """Temporary tab with explicit unavailable status."""

    def __init__(self, parent=None) -> None:
        super().__init__(tab_name="DebugTab", parent=parent)
