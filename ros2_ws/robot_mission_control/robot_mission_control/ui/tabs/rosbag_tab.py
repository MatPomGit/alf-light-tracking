...
# CO ZMIENIONO: Dodano szkielet zakładki RosbagTab jako jawnie niedostępny komponent UI.
...
# TODO: Zaimplementować logikę danych i akcje operatora dla zakładki RosbagTab.


class RosbagTab(UnavailableTab):
    """Temporary tab with explicit unavailable status."""

    def __init__(self, parent=None) -> None:
        super().__init__(tab_name="RosbagTab", parent=parent)
