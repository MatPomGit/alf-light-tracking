...
# CO ZMIENIONO: Dodano szkielet zakładki OverviewTab jako jawnie niedostępny komponent UI.
...
# TODO: Zaimplementować logikę danych i akcje operatora dla zakładki OverviewTab.


class OverviewTab(UnavailableTab):
    """Temporary tab with explicit unavailable status."""

    def __init__(self, parent=None) -> None:
        super().__init__(tab_name="OverviewTab", parent=parent)
