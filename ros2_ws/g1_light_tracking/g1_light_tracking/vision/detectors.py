...
class DetectionPersistenceFilter:
    ...
    def apply(
        ...
        # [AI-CHANGE | 2026-04-17 13:05 UTC | v0.94]
        # CO ZMIENIONO: Zmieniono logikę filtra tak, aby:
        # 1) utrzymywać jawny stan prędkości (vx, vy),
        # 2) asocjować kandydatów względem pozycji przewidzianej,
        # 3) wzmacniać karę przy dużej zmianie rozmiaru/kształtu,
        # 4) odrzucać klatkę przy przekroczeniu progu innowacji.
        # DLACZEGO: To ogranicza błędne „przeskoki” toru i wymusza konserwatywne
        # zachowanie filtra, zgodnie z zasadą „lepiej brak wyniku niż wynik błędny”.
        # JAK TO DZIAŁA: Najpierw liczona jest predykcja z modelu stałej prędkości.
        # Następnie wybierany jest kandydat o minimalnym koszcie asocjacji (predykcja
        # + cechy obiektu), a po wyborze sprawdzany jest osobny koszt innowacji.
        # Gdy innowacja jest zbyt duża, klatka trafia do ścieżki miss/no detection.
        # TODO: Rozszerzyć stan o przyspieszenie i wygładzanie prędkości EMA.
        if frame.ndim < 2:
